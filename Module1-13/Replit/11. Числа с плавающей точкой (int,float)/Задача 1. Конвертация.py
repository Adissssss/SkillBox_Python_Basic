...
cost = float(input('Введите сумму покупки в евро: '))
euro_dollar_rate = 1.25
dollar_rub_rate = 60.87
in_dollars = cost *  euro_dollar_rate
in_rub = in_dollars * dollar_rub_rate
print(f'сумма в рублях: {in_rub}')