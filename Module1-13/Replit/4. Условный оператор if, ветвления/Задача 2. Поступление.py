...
russ_lang = int(input('number of points in mathematics: '))
math = int(input('number of points in russian: '))
infor = int(input('number of points in informatics: '))

if russ_lang + math + infor >= 270:
    print('Congratulations! You entered the budget!')
else:
    print('Unfortunately, You did not enter.')